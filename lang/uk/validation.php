...
return [
    ...
    'default_active' => 'Пристрій за замовчуванням має бути активним',
    'unique_default' => 'Пристрій за замовчуванням має бути один',
    'device_binded' => "Пристрій :name вже прив'язаний до машини",
    'forbidden_device' => 'Ви не маєте доступу до пристрою :name',
    'wrong_count' => ':attribute з id :id не знайдено',
    'sensor_brand' => 'Cенсор :name не відноситься до моделі обраного пристрою',
    'forbidden_vehicle' => 'Ви не маєте доступу до обраної машини',
    'unique_default_organization' => 'Група за замовчуванням для цієї організації вже існує',
];
